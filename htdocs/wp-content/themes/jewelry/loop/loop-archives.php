...
<div id="post-<?php the_ID(); ?>" <?php post_class('post-holder'); ?>>
	<div class="post-content">
		...
		<div class="archive_lists">
			<div class="row-fluid">
				<div class="span4">
					<h4 class="archive_h"><?php echo theme_locals("last_posts"); ?></h4>
				...
				<div class="span4">
					<h4 class="archive_h"><?php echo theme_locals("archives_month"); ?></h4>
					<div class="list styled check-list">
						<ul>
				...
				<div class="span4">
					<h4 class="archive_h"><?php echo theme_locals("archives_subject"); ?></h4>
					<div class="list styled check-list">
						<ul>
